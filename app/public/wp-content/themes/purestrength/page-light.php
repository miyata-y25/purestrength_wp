    ...
    <main id="l-main">
      ...
      <div id="catch1">
        <div class="inner max-width-none full-width">
          ...
          <p class="taC"><img class="full-width_ il-hide-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/txt-catch-01_.svg" alt="1日20分だけでOK!画期的なサーキットトレーニング！　■AI（人工知能）があなたに最適なトレーニングプログラムを作成！　■記憶したウエルネスバンドでログインするだけでトレーニングスタート！！ ■マシン調節も自動にセッティング！ガイド通りにトレーニングするだけ！　これなら続く！無理せず理想ボディへ近づく！"><img class="il-show-md_" src="<?php echo esc_url(home_url()); ?>/shared/light/img/txt-catch-01-pc_.svg" alt="1日20分だけでOK!画期的なサーキットトレーニング！　■AI（人工知能）があなたに最適なトレーニングプログラムを作成！　■記憶したウエルネスバンドでログインするだけでトレーニングスタート！！ ■マシン調節も自動にセッティング！ガイド通りにトレーニングするだけ！　これなら続く！無理せず理想ボディへ近づく！" width="1440">
          </p>
        </div>
      </div>
      <div id="catch2">
      ...
      <section class="CTA taC">
        <div class="inner max-width-none full-width">
          ...
          <p class="benefit-01"><img class="il-hide-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/txt-cta-01.svg" alt="オープン前特典 01　オープン後もずっとおトク！ 月会費永久550円引き！ 男性会員なら通常7,128円（税込）が¥6,578税込　女性会員なら通常6,380円（税込）が¥5,830税込　高校生なら通常5,500円（税込）が¥4,950税込" loading="lazy"><img class="il-show-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/txt-cta-01-pc.svg" alt="オープン前特典 01　オープン後もずっとおトク！ 月会費永久550円引き！ 男性会員なら通常7,128円（税込）が¥6,578税込　女性会員なら通常6,380円（税込）が¥5,830税込　高校生なら通常5,500円（税込）が¥4,950税込" loading="lazy" width="755">
          </p>
          <p class="btn-area"><a href="https://www.slim-sng.jp/slim/web/d/sng/web_admission_procedure/?c=Su5Rf9wA3m&f=00002" target="_blank" rel="noopener"><img class="il-hide-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/btn-cta-01.svg" alt="先行WEB入会はコチラ！" loading="lazy"><img class="il-show-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/btn-cta-01-pc.svg" alt="先行WEB入会はコチラ！" loading="lazy" width="411"></a></p>
        </div>
      </section>
        ...
        <div class="intro max-width-none full-width clWhite">
          <div class="contentsWidth">
            ...
            <figure class="figure01">
              <img src="<?php echo esc_url(home_url()); ?>/shared/light/img/pic-bio-01.png" class="il-hide-md" alt="">
              <img src="<?php echo esc_url(home_url()); ?>/shared/light/img/pic-bio-01-pc.png" class="il-show-md" alt="">
            </figure>
            <figure class="figure02">
              <img src="<?php echo esc_url(home_url()); ?>/shared/light/img/pic-bio-02.png" class="il-hide-md" alt="">
              <img src="<?php echo esc_url(home_url()); ?>/shared/light/img/pic-bio-02-pc.png" class="il-show-md" alt="">
            </figure>
      ...
      <section id="facility">
        ...
        <ul class="facility-list max-width-none full-width taC fwBold">
          ...
          <li>最新AIマシン<br>導入！</li>
          <li>フリーWi-Fi<br>完備</li>
          <li><span>サプリメントサーバー</span><br>3コース完備<br><small>※有料</small></li>
          <li>オープンロッカー<br>完備</li>
        </ul>
        ...
        <div class="max-width-none full-width" id="point03">
          <div class="contentsWidth">
            ...
            <p class="txt1">水素水はおいしいミネラルウォーター。<br class="sp">ナノレベルで豊富な<br class="pc">水素を含み、<br class="sp">良質な水分補給に最適な飲料です。</p>
            <div class="sec1 taC">
              <p class="img"><img class="il-hide-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/txt-facility-03.png" alt="専用ボトル購入の方に プラスチック500円(税込） アルミボトル700円(税込） （全6色）" loading="lazy"><img class="il-show-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/txt-facility-03-pc.png" alt="専用ボトル購入の方に プラスチック500円(税込） アルミボトル700円(税込） （全6色）" loading="lazy" width="420">
              </p>
            </div>
          </div>
        </div>
        <div class="max-width-none full-width" id="point04">
          <div class="contentsWidth posr">
            <h3 class="taC">
              <span class="db fwBold">手軽に自分専用のサプリをゲット!</span>
              <img class="txt il-hide-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/h-facility-07.svg" alt="オーダーメイドサプリメントサーバー完備!" loading="lazy">
              <img class="txt il-show-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/h-facility-07-pc.svg" alt="オーダーメイドサプリメントサーバー完備!" loading="lazy" width="850">
            </h3>
            <div class="sec1 taC">
              <figure class="figure01">
                <img class="txt il-hide-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/point04_01.png" alt="" loading="lazy">
                <img class="txt il-show-md" src="<?php echo esc_url(home_url()); ?>/shared/light/img/point04_01_pc.png" alt="" loading="lazy">
              </figure>
              <figure class="figure02">
                <img class="txt" src="<?php echo esc_url(home_url()); ?>/shared/light/img/point04_02_pc.svg" alt="" loading="lazy">
              </figure>
            </div>
          </div>
        </div>
      ...
      <section class="taC" id="joining">
        ...
        <p class="strong fwBold">入会時諸費用をお支払い後、<br>入退館用QRコードの発行、初期設定の<br class="il-hide-md">ご予約をお取りいたします。</p>
        <h3 class="fwMed">《お持ちいただく物》</h3>
        <div class="joining-list fwBold full-width">
          <div class="kaihi">
            <p>入会登録料 + 初月分・次月分月会費 <br class="il-hide-md">まとめて <span class="num">8,800</span><small>円(税込)</small></span></p>
      ...
      <section id="price">
        ...
        <ul class="price-list full-width">
          ...
          <li class="joining vhc"><span class="fee">ビジター利用料</span><span class="title">1回利用</span><span class="price"><span class="num DIN"><small class="yen">¥</small>2,750</span><small class="tax">税込</small></span></li>
        </ul>
      ...
      <section id="faq">
        ...
        <dl class="faq-list">
          ...
          <dd><span>店舗にスタッフがいる時間は11：00～20：00（月曜/木曜/臨時スタッフ不在日を除く）となります。お手続きやお問い合わせはこの時間内に承ります。<br>※毎週月曜/木曜日はスタッフが不在となりますのでご注意ください。<br>※年末年始など臨時にスタッフが不在の場合がございます。インフォメーションをご確認のうえ、ご来店ください。</span></dd>
          ...
          <dd><span>AIシステムが、お一人おひとりに最適なトレーニングメニューを自動で作成します。トレーニング中は、モニターにメニュー内容が表示され、指示に従って進められます。マシンの使い方やシートの調整は、スタッフがサポートいたしますのでご安心ください。</span></dd>
          ...
          <dd><span>ウェア・タオル・シューズのレンタルはございません。<br class="il-hide-md">ご自身でご準備ください。</span></dd>
          ...
          <dd><span>月額1,100円（税込）で休会可能です。 毎月10日までにお手続きいただくと、翌月1日から休会となります。<br>（10日がスタッフ不在日の場合は、前日9日が締日となりますのでご注意ください。）</small></span></dd>
          <dt><span>退会したい、オプションを解約したい場合は<br class="il-hide-md">どうすればよいですか？</span></dt>
          <dd><span>毎月10日までにお手続きいただくと、当月末に退会、解約となります。<br>（10日がスタッフ不在日の場合は、前日9日が締日となりますのでご注意ください。）</span></dd>
          <dt><span>ビジターで利用できますか？</span></dt>
          <dd><span>ご本人様確認証のご提示とビジター料金￥2,750(税込)/1回でご利用いただけます。<br>※マシンの初期設定に1時間ほどお時間をいただきます。<br>※スタッフ対応時間（11:00～20:00）内のみご利用いただけます。<br>※最終受付は18:00となります。<br>※スタッフ不在日はインフォメーションをご確認のうえ、ご来店ください。<br>※施設のご利用は16歳以上の方のみとさせていただきます。<br>★ビジター利用日より2週間以内にご入会の場合、入会費用よりビジター料金を割引させていただきます！</span></dd>
        </dl>
      </section>
      <section id="access">
